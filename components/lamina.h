...
class Lamina{
	...
	public:
        ...
        void setCompensationPercent( double compensationPercent ){
            this->compensationPercent = compensationPercent;
        }

        double getCompensationPercent() const{
        ...
        std::string toString() const{
            ...
            txt += "Lamina Compensation Percent: " + std::to_string( this->getCompensationPercent() ) + " %\n";
        ...
        std::string toHTML() const{
            ...
            txt += "\t<tr><td align=\"right\">Lamina compensation Percent:</td><td><b>" + std::to_string( this->getCompensationPercent() ) + " %</b></td></tr>\n";
        ...
        std::string toSQL() const{
            std::string txt = "";
            txt += "INSERT INTO laminas (width_lamina, window_area_lamina, weight_lamina, compensation_percent_lamina, type_lamina, provider_lamina) ";
            txt += "VALUES( ";
            txt += std::to_string( this->getWidth() )            + ", ";
            txt += std::to_string( this->getWindowArea() )       + ", ";
            txt += std::to_string( this->getWeight() )           + ", ";
            txt += std::to_string( this->getCompensationPercent() ) + ", ";
            txt += "'" + this->getType()                         + "', ";
