...
-- centerTap
-- compensationLossTransformerState
-- compensationLossTransformerValue -- >= 0
--
-- powerIN                     -- W
...
-- laminaWeight                -- kg/cm
-- laminaCompensationState
-- laminaCompensationValue     -- >= 0
-- 
-- bobbinID
-- bobbinType
-- bobbinCode
...
CREATE TABLE IF NOT EXISTS transformer (
	...
	compensationLossTransformerState BOOLEAN,
	compensationLossTransformerValue FLOAT,        -- >= 0
	...
	laminaCompensationState     BOOLEAN,
	laminaCompensationValue     FLOAT,        -- >= 0
...
INSERT INTO transformer (
	...
	centerTap,
	compensationLossTransformerState,
	compensationLossTransformerValue,
...
VALUES (
	...
	TRUE,			-- center tap,
	TRUE,			-- compensationLossTransformerState,
	10.0,			-- compensationLossTransformerValue,
	...
	1.05,			-- laminaWeight,
	TRUE,			-- laminaCompensationState,
	10.0,			-- laminaCompensationValue,
